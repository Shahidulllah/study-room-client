            ...
            <div className="carousel lg:max-w-9/12  rounded-b-xl h-[40vh] lg:h-[70vh]">
                <div id="slide1" className="carousel-item relative w-full  ">
                    ...
                    <div className="bg-black/30 absolute  w-full h-full flex flex-col justify-center items-center lg:items-start text-white P-8 space-y-10 lg:pl-16">
                        <h1 className="text-3xl lg:text-5xl font-serif font-bold text-center animate__slow animate__animated animate__fadeInUp ">Proactively strategize tactical <br /> mindshare with.</h1>
                        <h1 className="lg:text-3xl text-center hidden lg:block animate__slow animate__animated animate__fadeInUp lg:ml-16 p-6 rounded-2xl bg-purple-200 text-indigo-900 ">Progressively syndicate extensible growth.</h1>
                    </div>
